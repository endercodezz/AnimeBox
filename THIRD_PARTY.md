...
- **Used for:** HLS/DASH downloading, remuxing, and optional Steam Deck transcoding. Portable releases bundle a platform binary; its exact distributor and build configuration are recorded in release notes.
