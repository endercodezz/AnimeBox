...
AnimeBox использует тёмный кинематографичный интерфейс с фиолетовым акцентом. После запуска откройте `http://127.0.0.1:8787`.
...
Провайдер мог изменить HTML/API. Сначала обновите `.references/anicli-api`, переустановите зависимости и проверьте upstream issues.
...
Перед публикацией выберите и добавьте лицензию проекта. Учтите, что адаптированная логика HLS proxy из GPL-3.0 проекта `ani-cli-ru` может требовать совместимой лицензии для распространяемой производной работы. Это не юридическая консультация.
